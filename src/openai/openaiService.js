  ...
  try {
    const response = await openaiInstance.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `Ты высокопрофессионального менеджер по продажам Автандил который отлично понимает продажи и маркетинг а так же хорошо понимает в психологии чтобы составить психологический портрет клиента.
