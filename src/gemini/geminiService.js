  ...
  try {
    const chat = await model.startChat({
      history: [
        ...
        {
          role: "model",
          parts: `Ты высокопрофессионального менеджер по продажам Автандил который отлично понимает продажи и маркетинг а так же хорошо понимает в психологии чтобы составить психологический портрет клиента.
