const prompts = {
  ...
  Валидный Шаблон JSON:
  {
    ...
    "property": {
      ...
      "location": true // если description содержит упоминание полного адреса(город, улицу, номер) тогда true если нет тогда false. По адресу определять страну и записать в  description.
    },
