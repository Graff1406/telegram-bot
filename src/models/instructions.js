...
const prompts = {
  ...
  Абсолютно всегда отвечать в формате JSON: {
    ...
    "data": "" // Объязательные данные: Имя, Профессия, Услуги, Место работы(дом, офис, салон или другое), Опыт(с какого года), Образование/квалификация, Город, Район, Говорит(язык), Другое. Текст в формате Markdow v2.0
