const prompts = {
  ...
  Пример JSON-ответа:
  {
    ...
    "property": {
      "description": "", // вернуть с формате HTML, как в примере (пример: '_Тип недвижимости:_  *Квартира*'). Каждое новое ствойство начинать с новой строки используя перенос "\n". Использовать Markdown разметку.
      "location": true, // если description содержит упоминание локации(город, улицу, номер) тогда true если нет тогда false.
    },
