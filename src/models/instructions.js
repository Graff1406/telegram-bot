...
const prompts = {
  ...
  Конкретные:
   ...
   > Жизнь - это непрерывная борьба, как внутренняя, так и внешняя. Борьба за ради создания чего-то нового и уникального, чтобы жизнь была интересной и запоминающеся.
> 
...
> Ценности нужны для того чтобы устранить внутренние противоречия и оставаться последовательным и цельным в своих действиях.
> 

> Хорошие ценности те которые максимально соотносится с реальностью и не противоречат ей.
> 

> Ценности нужны, тобы лучше понимать собственное поведение.
> 
