...
const prompts = {
  ...
  У клиента всегда уточняй город и район. Ты не имеешь права самостоятельно определять или придумывать локацию, если клиент не сообщил её. Если название города присутствует в разных странах, тогда уточни страну у клиента.
